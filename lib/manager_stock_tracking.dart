...
class ManagerStockTracking extends StatefulWidget {
  final Map<String, dynamic> managerProfile;

  const ManagerStockTracking({
    super.key,
    required this.managerProfile,
  });

  @override
  State<ManagerStockTracking> createState() => _ManagerStockTrackingState();
}

class _ManagerStockTrackingState extends State<ManagerStockTracking> {
  String searchQuery = "";
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, userSnapshot) {
        ...
        if (userSnapshot.hasData && userSnapshot.data!.docs.isNotEmpty) {
          ...
          supplierPhone = supplierData['phone'] ?? "No Phone";
        }
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              GestureDetector(
                                onTap: () => _showPhonePopup(supplierPhone, data['supplierName'] ?? "Supplier"),
  ...
  void _showPhonePopup(String phone, String name) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            Text(phone, style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          ],
        ),
        actions: [
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDrawerItem(Icons.analytics, "Financial", onTap: () {
                setState(() => isDrawerOpen = false);
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ManagerFinancialScreen(managerProfile: widget.managerProfile)));
              }),
